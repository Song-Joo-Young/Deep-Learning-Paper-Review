# 딥러닝 논문 리뷰 및 요약 : Deep-Learning-Paper-Review
...
* T5 : Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer [arXiv 2019]
     *  [Original Paper Link](https://arxiv.org/abs/1910.10683) / [Paper Review Post](https://songsite123.tistory.com/92) / [Code Practice](https://github.com/Song-Joo-Young/ToTTo-Fine-tuning-in-colab/blob/main/t5-base_Full-fine-tuning/train/ToTTo_T5_base_Fine_tuning_5epoch.ipynb) 
...
* Attention is All You Need (NIPS 2017)
    * [Original Paper Link](https://arxiv.org/pdf/1706.03762.pdf) / [Paper Review post](https://songsite123.tistory.com/76) / [Code Practice](https://github.com/Song-Joo-Young/Deep-Learning-Paper-Review/blob/main/Code%20Practice/Attention_is_All_You_Need_Tutorial_(English_to_Korean).ipynb)
